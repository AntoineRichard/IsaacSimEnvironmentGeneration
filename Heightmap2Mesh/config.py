...
def parseArgs():
    ...
    parser.add_argument("--num_cells_x", type=int, default=0.0, help="Used in cell or point decimation mode. The number of cell to be used along the x axis. This will force the resulting mesh to only have N cells along the x axis.")
    parser.add_argument("--num_cells_y", type=int, default=0.0, help="Used in cell or point decimation mode. The number of cell to be used along the x axis. This will force the resulting mesh to only have N cells along the y axis.")
